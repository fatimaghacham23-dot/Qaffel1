...
export function DashboardHome(props: {
  ...
  if (props.onboarding) return <Onboarding steps={props.onboarding} name={props.name} />;
  ...
  return (
    <main className="mx-auto max-w-[1480px]">
      <header className="mb-8 flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
        ...
        <div className="flex flex-wrap gap-2">{props.capabilities.canCreateInvoice ? <Link href="/invoices/new" className="btn btn-primary">Create invoice</Link> : null}{props.capabilities.canRecordPayment ? <Link href="/invoices" className="btn btn-secondary">Record payment</Link> : null}</div>
      </header>
